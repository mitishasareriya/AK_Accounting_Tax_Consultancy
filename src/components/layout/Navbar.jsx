          ...
          <div className="container-fluid">
            ...
            <div className="col-auto col-xxl-3 col-lg-2 me-lg-0 me-auto">
              <Link className="navbar-brand" to="/">
                <img src="/images/logo_vertical.svg" data-at2x="/images/demo-it-business-logo-white@2x.png" alt="Crafto" className="default-logo" />
                <img src="/images/logo_vertical.svg" data-at2x="/images/demo-it-business-logo-black@2x.png" alt="Crafto" className="alt-logo" />
                <img src="/images/logo_vertical.svg" data-at2x="/images/demo-it-business-logo-black@2x.png" alt="Crafto" className="mobile-logo" style={{ maxHeight: '250px' }} />
              </Link>
            </div>
            ...
            <div className="mCSB_container">
              ...
              <div className="text-center mb-5">
                <Link className="navbar-brand d-inline-block text-center" to="/" onClick={closeMenu}>
                  <img src="/images/logo_vertical.svg" alt="Crafto" style={{ maxHeight: '50px' }} />
                </Link>
              </div>
